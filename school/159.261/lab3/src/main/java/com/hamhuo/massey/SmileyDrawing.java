...
public class SmileyDrawing extends JPanel {
	...
	public void paintComponent(Graphics g) {
		...
		drawSolidCircle(g, 200, 200, 100); // 吃豆人的头

		// 画嘴巴（用两条线段形成一个开口）
		changeColor(g, black);
		drawSolidRectangle(g, 200, 200, 100, 50);
		drawLine(g, 200, 200, 250, 150); // 上嘴角
		drawLine(g, 200, 200, 250, 250); // 下嘴角

		// 画眼睛（用小矩形表示）
		changeColor(g, black);
		drawSolidRectangle(g, 220, 130, 35, 15); // 眼睛
	}
}
